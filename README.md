...
This is a website development project for chatting with friends, built using the Django framework and SQLite3 database.

## Installation

To run the program, you need to have Python and Django installed on your computer. Here are the steps to get started:
